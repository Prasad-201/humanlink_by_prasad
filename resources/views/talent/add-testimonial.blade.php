    ...
    <div class="container">
        ...
        <div class="profile-Accordion accordionOpen opened">
            <div class="accordionContent accordionContentOpen">
                <form action="{{ url('/Talent/add-testimonial') }}" method="post" autocomplete="off"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-lg-6 col-xl-6 form-group">
                            <label>Client Name</label>
                            <input type="text" name="client_name" value="{{ old('client_name') }}" class="form-control-element">
                        ...
                        <div class="col-lg-6 col-xl-6 form-group">
                            ...
                            <input type="text" name="company_name" value="{{ old('company_name') }}" class="form-control-element">
                        ...
                        <div class="col-lg-12 col-xl-12 form-group">
                            ...
                            <textarea name="testimonial" class="form-control-element" required>{{ old('testimonial') }}</textarea>
